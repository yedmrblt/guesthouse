import ButtonGumroad from "@/components/pulse-for-vercel/button-gumroad";
  ...
  return (
    <>
      <Container size="xlarge">
        <div className="flex flex-1 justify-center px-0 pt-8 pb-16 sm:pt-16 sm:pb-28 xl:px-36">
          <section className="flex w-full flex-col items-center">
            <Hero></Hero>
            <Desktop></Desktop>
            <div className="mt-[600px] w-full sm:mt-28">
